# Bead: Chapter 02 Order Book AIism Audit

## Parent Epic
- `beads/epic-handbook-chapter-audit.md`

## Chapter
- `/Users/jaredsmith/Projects/x-woodchipdaddy/handbook/chapters/02-order-book.md`

## Required Workflow
1. Deterministic scan first.
- Run: `aism scan --json --file /Users/jaredsmith/Projects/x-woodchipdaddy/handbook/chapters/02-order-book.md --top-matches 300`
